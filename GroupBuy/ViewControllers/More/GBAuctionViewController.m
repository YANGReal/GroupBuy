...
@implementation GBAuctionViewController
...
- (void)setRightButton
{
    ...
    [button setBackgroundImage:[UIImage imageFromMainBundleFile:@"add_icon.png"] forState:UIControlStateNormal];
